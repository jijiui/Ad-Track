...
//  Adtrack_bgm2
//
//  Created by Wyat Da on 29/05/2017.
...
class AudioManager: NSObject {
    ...
    private func setupBackgroundAudioPlayer() {
        do {
            self.backgroundAudioPlayer = try AVAudioPlayer(contentsOf: URL(fileURLWithPath: Bundle.main.path(forResource: "Sound 1", ofType: "mp3")!))
